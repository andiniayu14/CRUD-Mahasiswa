  ...
  <body>
    <div class="container">
        <div class="col-md-12"></div>
            <h3 style="margin: 20px 0px 20px 0px">Updateh Data Mahasiswa</h3>
            <form method="post" action="edit_aksi.php" class="form_horizontal">
              ...
              <div class="mb-3">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="keahlian[]" value="Enterpise Architecture"<?php if(in_array("Enterpise Architecture", $checked)) echo "checked" ?>>
                  <label class="form-check-label">
